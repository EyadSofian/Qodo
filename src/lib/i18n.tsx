...
const STRINGS = {
  ...
  'role.manager.desc': {
    ar: 'يرى جميع المهام ويعدّلها، ويرى المستخدمين — دون تعديل على النظام.',
    en: 'Sees and edits every task, and sees users — but cannot change the system.',
  },
  'role.member.desc': {
    ar: 'يرى التطبيقات المسموح بها، ويعمل على مهامه.',
    en: 'Sees their allowed apps and works on their own tasks.',
  },
  'role.viewer.desc': {
  ...
  'perm.tasks.view_all': { ar: 'رؤية مهام الفريق كاملة', en: 'View the whole team’s tasks' },
