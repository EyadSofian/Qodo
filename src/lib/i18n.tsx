...
const STRINGS = {
  ...
  'tasks.newHint': {
    ar: 'المهمة تُسند لشخص واحد ويصله إشعار بها. التقييم يأتي لاحقاً — بعد أن يسلّم عمله وتراجعه.',
    en: 'A task goes to one person, who gets a notification. The score comes later — after they hand the work in and you review it.',
  },
