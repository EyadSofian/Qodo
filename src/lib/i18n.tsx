...
const CORE_STRINGS = {
  ...
  'tasks.hrOperations': { ar: 'تشغيل HR', en: 'HR operations' },
  ...
  /* ── HR operations command centre ───────────────────────── */
  'hrOps.eyebrow': { ar: 'لوحة التشغيل اليومية', en: 'Daily operations board' },
  'hrOps.title': { ar: 'مركز تشغيل الموارد البشرية', en: 'HR operations command centre' },
  'hrOps.subtitle': {
    ar: 'كل الالتزامات الدورية في مكان واحد: من الاستحقاق والمسؤول إلى دليل الإنجاز والمراجعة.',
    en: 'Every recurring obligation in one place, from due date and owner to evidence and review.',
  },
  'hrOps.basePlan': { ar: 'مهام الخطة الأساسية', en: 'Base plan tasks' },
  'hrOps.dueToday': { ar: 'مستحقة اليوم', en: 'Due today' },
  'hrOps.overdue': { ar: 'متأخرة', en: 'Overdue' },
  'hrOps.inProgress': { ar: 'قيد التنفيذ', en: 'In progress' },
  'hrOps.awaitingReview': { ar: 'بانتظار المراجعة', en: 'Awaiting review' },
  'hrOps.catalogue': { ar: 'خطة العمل الدورية', en: 'Recurring work plan' },
  'hrOps.catalogueHint': {
    ar: 'اختر قالباً لفتح مهمة فعلية داخل دورة الإسناد والتسليم الحالية.',
    en: 'Choose a template to create a live task in the existing assignment and delivery flow.',
  },
  'hrOps.matches': { ar: '{n} مهمة', en: '{n} tasks' },
  'hrOps.search': { ar: 'ابحث في الخطة…', en: 'Search the plan…' },
  'hrOps.allTracks': { ar: 'كل مسارات HR', en: 'All HR tracks' },
  'hrOps.allCadences': { ar: 'كل الدوريات', en: 'All cadences' },
  'hrOps.deadline': { ar: 'الموعد', en: 'Deadline' },
  'hrOps.proof': { ar: 'دليل الإنجاز', en: 'Evidence' },
  'hrOps.create': { ar: 'حوّلها لمهمة', en: 'Create task' },
  'hrOps.noTemplates': { ar: 'لا توجد مهام تطابق الفلاتر الحالية.', en: 'No templates match these filters.' },
  'hrOps.liveWork': { ar: 'العمل الجاري', en: 'Live work' },
  'hrOps.liveWorkHint': { ar: 'الأقرب في الاستحقاق أولاً', en: 'Nearest due date first' },
  'hrOps.noDeadline': { ar: 'بدون موعد محدد', en: 'No due date' },
  'hrOps.noLiveWork': { ar: 'لا توجد مهام HR مفتوحة حالياً', en: 'No open HR tasks right now' },
  'hrOps.planMix': { ar: 'توزيع الخطة', en: 'Plan mix' },
  'hrOps.automationTitle': { ar: 'التشغيل التلقائي', en: 'Automatic operation' },
  'hrOps.automationBody': {
    ar: 'يُنشئ المستحق في نافذته مرة واحدة فقط، وينبّه المسؤول المختار.',
    en: 'Creates each due occurrence once and notifies its selected owner.',
  },
  'hrOps.automatic': { ar: 'تلقائي', en: 'Automatic' },
  'hrOps.notAutomated': { ar: 'غير مفعّل', en: 'Not enabled' },
  'hrOps.eventDriven': { ar: 'حسب حدث', en: 'Event-driven' },
  'hrOps.runDue': { ar: 'شغّل المستحق', en: 'Run due work' },
  'hrOps.configure': { ar: 'الإعداد', en: 'Configure' },
  'hrOps.settingsTitle': { ar: 'إعداد تشغيل مهام HR الدورية', en: 'Configure recurring HR tasks' },
  'hrOps.saveAutomation': { ar: 'حفظ وتشغيل', en: 'Save and activate' },
  'hrOps.safeAutomation': { ar: 'تشغيل آمن بدون ازدواج', en: 'Safe, duplicate-free automation' },
  'hrOps.safeAutomationBody': {
    ar: 'فعّل فقط المهام التي تريدها واختر مسؤولاً لكل واحدة. المهام المرتبطة بحدث فعلي لا يولدها الوقت وتظل متاحة من الكتالوج.',
    en: 'Enable only the work you need and assign an owner. Event-driven tasks remain available from the catalogue and are never invented by the clock.',
  },
  'hrOps.taskOwner': { ar: 'المسؤول الفعلي', en: 'Task owner' },
  'hrOps.chooseOwner': { ar: 'اختر موظف HR', en: 'Choose an HR employee' },
  'hrOps.ownerRequired': { ar: 'اختر مسؤولاً لكل مهمة مفعّلة قبل الحفظ.', en: 'Choose an owner for every enabled task before saving.' },
  'hrOps.automationSaved': { ar: 'تم حفظ إعدادات التشغيل التلقائي.', en: 'Automation settings saved.' },
  'hrOps.generatedCount': { ar: 'تم إنشاء {n} مهمة مستحقة.', en: '{n} due task(s) created.' },
  'hrOps.nothingDue': { ar: 'لا توجد مهام جديدة مستحقة الآن؛ الموجود لم يتكرر.', en: 'Nothing new is due now; existing work was not duplicated.' },
  ...
  'profile.speedHint': { ar: 'من أول ما تبدأ لحد ما تقفل', en: 'From picking it up to closing it' },
  'profile.daysTypical': { ar: 'يوم في المتوسط المعتاد', en: 'days, typically' },
  'profile.fastest': { ar: 'أسرع مهمة', en: 'Fastest' },
  'profile.average': { ar: 'المتوسط', en: 'Average' },
  'profile.slowest': { ar: 'أبطأ مهمة', en: 'Slowest' },
  'profile.day': { ar: 'يوم', en: 'd' },
  'profile.timedFrom': { ar: 'محسوبة من {n} مهمة مقفولة', en: 'From {n} closed tasks' },
  'profile.noTiming': {
    ar: 'لسه مفيش مهمة اتقفلت عشان نقيس بيها.',
    en: 'Nothing closed yet to measure.',
  },
  'profile.quality': { ar: 'الجودة', en: 'Quality' },
  'profile.qualityHint': {
    ar: 'في الميعاد، ومن أول مرة، ونسبة الإنجاز',
    en: 'On time, first pass, and completion',
  },
  ...
  'perm.hr.recruitment.request': { ar: 'التوظيف: تقديم طلب وظيفة', en: 'Recruitment: submit job requests' },
  'perm.hr.recruitment.review': { ar: 'التوظيف: مراجعة طلبات القسم', en: 'Recruitment: department review of requests' },
  'perm.hr.recruitment.approve': { ar: 'التوظيف: الاعتماد النهائي وبدء التعيين', en: 'Recruitment: final approval and start hiring' },
  'perm.hr.recruitment.assign': { ar: 'التوظيف: إسناد المسؤول وإدارة الوظائف النشطة', en: 'Recruitment: assign recruiters and run active hiring' },
  'perm.hr.recruitment.extend': { ar: 'التوظيف: مد مهلة الـSLA (صلاحية مخصصة)', en: 'Recruitment: extend an SLA deadline (dedicated)' },
  'perm.hr.recruitment.override_capacity': { ar: 'التوظيف: تجاوز حد السعة بسبب مكتوب', en: 'Recruitment: override a capacity limit with a reason' },
  'perm.hr.recruitment.kpi.review': { ar: 'التوظيف: تسجيل خصومات مؤشرات الأداء', en: 'Recruitment: record KPI deductions' },
  'perm.hr.recruitment.rewards.manage': { ar: 'التوظيف: اعتماد دفعات المكافآت', en: 'Recruitment: approve reward batches' },
  'perm.hr.personnel.view': { ar: 'شئون العاملين: الرؤية', en: 'Personnel: view' },
  'perm.hr.personnel.manage': { ar: 'شئون العاملين: إدارة الطلبات والتهيئة والإخلاء', en: 'Personnel: manage requests, onboarding and clearance' },
  'perm.hr.performance.review': { ar: 'الأداء: إجراء التقييمات الربع سنوية', en: 'Performance: run quarterly reviews' },
  'perm.hr.settings.manage': { ar: 'إعدادات HR: القواعد والمهل والمكافآت', en: 'HR settings: rules, SLAs and rewards' },
  ...
  'assistant.notConfigured': {
    ar: 'المساعد غير مفعّل. هيّئ QODO_AI_BASE_URL أو OPENAI_API_KEY ثم أعد تشغيل الخادم.',
    en: 'The assistant is not configured. Set QODO_AI_BASE_URL or OPENAI_API_KEY, then restart the server.',
  },
  ...
  'assistant.confirm': { ar: 'تأكيد الإنشاء', en: 'Confirm creation' },
  'assistant.confirming': { ar: 'جارٍ الإنشاء…', en: 'Creating…' },
  'assistant.cancel': { ar: 'إلغاء', en: 'Cancel' },
  'assistant.dueDate': { ar: 'موعد التسليم', en: 'Due date' },
  'assistant.taskCreated': { ar: 'تم إنشاء المهمة بعد تأكيدك.', en: 'The task was created after your confirmation.' },
  'assistant.confirmFailed': { ar: 'تعذّر تنفيذ المهمة أو انتهت مهلة التأكيد.', en: 'The task could not be created or the confirmation expired.' },
