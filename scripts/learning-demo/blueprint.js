...
export const PEOPLE = [
  ...
  { ref: 'salma', name: 'سلمى الشريف', title: 'مصممة تعليمية', avatarColor: '#7C3AED' },
  { ref: 'bassem', name: 'باسم فؤاد', title: 'خبير موضوع — كهرباء', avatarColor: '#12497A' },
  { ref: 'heba', name: 'هبة الشامي', title: 'كاتبة سكريبت', avatarColor: '#BE123C' },
...
export const COURSES = [
    ...
    modules: [
      {
        ...
        lessons: [
          ...
          'Maintenance Policy and Governance',
        ],
      },
      {
        name: 'Module 02 — Maintenance Performance',
        lessons: ['Maintenance KPIs', 'MTBF & MTTR', 'Availability', 'OEE Fundamentals', 'Benchmarking Maintenance Performance', 'Maintenance Cost Analysis', 'Reporting to Management'],
      },
      {
        name: 'Module 03 — Reliability',
        lessons: ['Asset Reliability', 'Failure Analysis', 'Failure Modes and Effects Analysis', 'RCM Fundamentals', 'Weibull Analysis Basics', 'Root Cause Analysis', 'Defect Elimination'],
      },
      {
        name: 'Module 04 — Work Management',
        lessons: ['Work Order Management', 'Maintenance Planning', 'Maintenance Scheduling', 'Backlog Management', 'Shutdown & Turnaround Planning', 'Contractor Management', 'Work Order Quality'],
      },
      {
        name: 'Module 05 — Asset Management',
        lessons: ['Preventive Maintenance', 'Predictive Maintenance', 'Inventory Optimization', 'Spare Parts Strategy', 'Asset Life Cycle Costing', 'Capital Replacement Decisions', 'ISO 55000 in Practice'],
      },
    ],
  },
  {
    ...
    modules: [
      { name: 'Module 01 — Design Basics', lessons: ['Engineering Drawing Standards', 'Tolerances and Fits', 'Material Selection', 'Design for Manufacturing', 'Surface Finish and Treatments'] },
      { name: 'Module 02 — Machine Elements', lessons: ['Shaft Design', 'Bearings and Lubrication', 'Gears and Gear Trains', 'Couplings and Clutches', 'Belts, Chains and Drives', 'Fasteners and Joints'] },
      { name: 'Module 03 — Stress and Strength', lessons: ['Stress Analysis Fundamentals', 'Fatigue and Endurance', 'Failure Theories', 'Finite Element Basics', 'Thermal Stress'] },
      { name: 'Module 04 — Applied Design', lessons: ['Pressure Vessel Basics', 'Piping Layout Essentials', 'Vibration in Rotating Machines', 'Design Review Practices', 'Tolerance Stack-up Analysis', 'Design Documentation'] },
    ],
  },
  {
    ref: 'pmp',
    ...
    modules: [
      ...
      { name: 'Module 02 — Planning', lessons: ['Scope Management', 'Schedule Development', 'Cost Estimating', 'Risk Planning', 'Resource Planning', 'Communications Planning'] },
      { name: 'Module 03 — Execution', lessons: ['Team Leadership', 'Stakeholder Engagement', 'Quality Management', 'Conflict Resolution'] },
  ...
  },
  {
    ...
    modules: [
      ...
      { name: 'Module 03 — Applied Reliability', lessons: ['Condition Monitoring', 'Vibration Analysis', 'Oil Analysis', 'Thermography', 'Ultrasound Testing', 'Motor Current Signature Analysis', 'Reliability Improvement Programmes'] },
    ],
  },
  {
    ref: 'hvac',
    ...
    modules: [
      ...
      { name: 'Module 02 — Systems', lessons: ['Air Distribution Systems', 'Chilled Water Systems', 'Duct Design', 'Fan and Pump Selection', 'VRF and Split Systems'] },
      { name: 'Module 03 — Controls and Efficiency', lessons: ['HVAC Controls', 'Energy Efficiency in HVAC', 'Indoor Air Quality', 'Commissioning HVAC Systems', 'Building Management Systems'] },
    ],
  },
  {
    ref: 'plan',
    ...
    modules: [
      ...
      { name: 'Module 02 — Scheduling', lessons: ['Network Diagrams', 'Critical Path Method', 'Resource Levelling', 'Schedule Baselines', 'Schedule Risk Analysis'] },
      { name: 'Module 03 — Control', lessons: ['Progress Measurement', 'Schedule Updating', 'Delay Analysis', 'Recovery Planning'] },
    ],
  },
  {
    ref: 'elec',
    ...
    code: 'ELEC-08',
    description: 'Low-voltage distribution, protection and earthing for building and industrial installations, worked against the Egyptian code and IEC 60364.',
    subject: 'electrical design',
    cover: { from: [11, 37, 69], to: [245, 130, 31], band: { top: 0.36, height: 0.08, color: [216, 233, 247] } },
    managerRef: 'bassem',
    priority: 'NORMAL',
    startOffset: -46,
    targetOffset: 68,
    lateness: 0.02,
    mix: ['DONE', 'VIDEO_REVIEW', 'VOICE_WORK', 'DONE', 'PPT_REVIEW', 'SCRIPT_WORK', 'EARLY'],
    overrides: { 'Earthing and Bonding': 'VIDEO_CHANGES', 'Cable Sizing': 'DONE' },
    team: {
      bassem: ['COURSE_MANAGER', 'SUBJECT_MATTER_EXPERT'],
      salma: ['INSTRUCTIONAL_DESIGNER'],
      rania: ['OUTLINE_WRITER'],
      kareem: ['PPT_DESIGNER'],
      heba: ['SCRIPT_WRITER'],
      laila: ['VOICE_OVER_ARTIST'],
      sherif: ['VIDEO_EDITOR'],
      dina: ['QUALITY_REVIEWER'],
    },
    defaults: {
      OUTLINE: ['rania', 'bassem'],
      PPT: ['kareem', 'salma'],
      SCRIPT: ['heba', 'sara'],
      VOICE_OVER: ['laila', 'tarek'],
      VIDEO: ['sherif', 'dina'],
    },
    modules: [
      { name: 'Module 01 — Fundamentals', lessons: ['Electrical Load Estimation', 'Cable Sizing', 'Voltage Drop Calculation', 'Short Circuit Basics'] },
      { name: 'Module 02 — Protection', lessons: ['Circuit Breakers and Fuses', 'Protection Coordination', 'Earthing and Bonding', 'Lightning Protection', 'Arc Flash Awareness'] },
      { name: 'Module 03 — Distribution', lessons: ['Panel Board Design', 'Busway Systems', 'Transformer Selection', 'Generator and ATS', 'Power Factor Correction'] },
      { name: 'Module 04 — Systems and Documentation', lessons: ['Lighting Design Basics', 'Small Power and Sockets', 'Single Line Diagrams', 'Electrical Specifications'] },
    ],
  },
  {
    ref: 'rot',
    ...
    code: 'ROT-09',
    description: 'Pumps, compressors and turbines — selection, alignment, balancing and the failure patterns each family is known for.',
    subject: 'rotating equipment',
    cover: { from: [14, 56, 94], to: [190, 18, 60], band: { top: 0.62, height: 0.1, color: [216, 233, 247] } },
    managerRef: 'khaled',
    priority: 'HIGH',
    startOffset: -88,
    targetOffset: 24,
    lateness: 0.09,
    mix: ['DONE', 'PPT_REVIEW', 'SCRIPT_CHANGES', 'VOICE_WORK', 'VIDEO_REVIEW', 'EARLY', 'PPT_CHANGES'],
    overrides: { 'Pump Cavitation': 'VIDEO_CHANGES', 'Shaft Alignment': 'VOICE_REVIEW' },
    team: {
      khaled: ['COURSE_MANAGER', 'SUBJECT_MATTER_EXPERT'],
      nour: ['INSTRUCTIONAL_DESIGNER'],
      rania: ['OUTLINE_WRITER'],
    ...
    modules: [
      { name: 'Module 01 — Pumps', lessons: ['Pump Types and Selection', 'Pump Curves', 'Pump Cavitation', 'Seals and Packing', 'Pump Troubleshooting'] },
      { name: 'Module 02 — Compressors', lessons: ['Compressor Types', 'Surge and Control', 'Compressor Lubrication', 'Compressor Troubleshooting'] },
      { name: 'Module 03 — Installation and Care', lessons: ['Shaft Alignment', 'Field Balancing', 'Baseplates and Grouting', 'Coupling Selection'] },
      { name: 'Module 04 — Turbines', lessons: ['Steam Turbine Basics', 'Gas Turbine Basics', 'Turbine Condition Monitoring'] },
    ],
  },
  {
    ref: 'lean',
    ...
    code: 'LEAN-10',
    description: 'Value stream mapping, 5S, kaizen and the measures that tell a real improvement from a rearranged shop floor.',
    subject: 'lean manufacturing',
    cover: { from: [18, 73, 122], to: [21, 128, 61], band: { top: 0.28, height: 0.12, color: [232, 247, 238] } },
    managerRef: 'salma',
    priority: 'LOW',
    startOffset: -22,
    targetOffset: 104,
    lateness: 0,
    mix: ['DONE', 'VOICE_REVIEW', 'PPT_REVIEW', 'EARLY', 'NOT_STARTED', 'SCRIPT_REVIEW'],
    overrides: { '5S in Practice': 'DONE' },
    team: {
      salma: ['COURSE_MANAGER', 'INSTRUCTIONAL_DESIGNER'],
      rania: ['OUTLINE_WRITER'],
      kareem: ['PPT_DESIGNER'],
      mona: ['SCRIPT_WRITER'],
      laila: ['VOICE_OVER_ARTIST'],
    ...
    modules: [
      { name: 'Module 01 — Foundations', lessons: ['What Lean Actually Is', 'The Seven Wastes', 'Value Stream Mapping', '5S in Practice'] },
      { name: 'Module 02 — Flow', lessons: ['Takt Time and Balancing', 'Pull Systems and Kanban', 'Setup Time Reduction', 'Cellular Layout'] },
      { name: 'Module 03 — Improvement', lessons: ['Kaizen Events', 'Standard Work', 'Visual Management', 'Problem Solving with A3', 'Measuring the Gain', 'Sustaining the Change'] },
    ],
  },
  {
    ref: 'safe',
    ...
    code: 'SAFE-11',
    description: 'Hazard identification, permit to work, and the risk assessments an engineering contractor is actually audited against.',
    subject: 'safety and risk',
    cover: { from: [11, 37, 69], to: [217, 108, 14], band: { top: 0.5, height: 0.14, color: [253, 227, 198] } },
    managerRef: 'dina',
    priority: 'URGENT',
    startOffset: -104,
    targetOffset: -12,
    lateness: 0.14,
    lateStages: ['VOICE_OVER', 'VIDEO'],
    mix: ['VOICE_WORK', 'VIDEO_CHANGES', 'PPT_CHANGES', 'SCRIPT_CHANGES', 'EARLY', 'OUTLINE_REVIEW', 'NOT_STARTED'],
    overrides: { 'Permit to Work': 'VIDEO_REVIEW', 'Incident Investigation': 'NOT_STARTED' },
    team: {
      dina: ['COURSE_MANAGER', 'QUALITY_REVIEWER'],
      bassem: ['SUBJECT_MATTER_EXPERT'],
      rania: ['OUTLINE_WRITER'],
      kareem: ['PPT_DESIGNER'],
      heba: ['SCRIPT_WRITER'],
      laila: ['VOICE_OVER_ARTIST'],
    ...
    modules: [
      { name: 'Module 01 — Hazards', lessons: ['Hazard Identification', 'Risk Assessment Methods', 'Hierarchy of Controls', 'Job Safety Analysis'] },
      { name: 'Module 02 — Site Control', lessons: ['Permit to Work', 'Confined Space Entry', 'Working at Height', 'Lockout Tagout', 'Hot Work Safety'] },
      { name: 'Module 03 — Response and Learning', lessons: ['Emergency Response Planning', 'Incident Investigation', 'Safety Culture', 'Contractor Safety', 'Safety Auditing', 'Reporting and Statistics'] },
    ],
  },
  {
    ref: 'data',
    name: 'Data Analysis for Engineers',
    code: 'DATA-12',
    description: 'Cleaning plant data, describing it honestly and building the handful of models a maintenance engineer will actually use. On hold until the analytics tooling is decided.',
    subject: 'engineering data analysis',
    cover: { from: [14, 56, 94], to: [124, 58, 237], band: { top: 0.2, height: 0.1, color: [237, 233, 254] } },
    managerRef: 'salma',
    priority: 'NORMAL',
    status: 'ON_HOLD',
    startOffset: -60,
    targetOffset: 48,
    lateness: 0.05,
    mix: ['EARLY', 'OUTLINE_REVIEW', 'NOT_STARTED', 'SCRIPT_WORK', 'PPT_REVIEW'],
    overrides: {},
    team: {
      salma: ['COURSE_MANAGER', 'INSTRUCTIONAL_DESIGNER'],
      bassem: ['SUBJECT_MATTER_EXPERT'],
    ...
    modules: [
      { name: 'Module 01 — Getting the Data Right', lessons: ['Where Plant Data Comes From', 'Cleaning Maintenance Records', 'Missing and Wrong Values', 'Joining Systems Together'] },
      { name: 'Module 02 — Describing It', lessons: ['Descriptive Statistics', 'Distributions That Matter', 'Charts That Do Not Lie', 'Correlation and Its Traps'] },
      { name: 'Module 03 — Using It', lessons: ['Regression for Engineers', 'Forecasting Demand', 'Reliability Models from Data', 'From Analysis to Decision', 'Presenting Findings'] },
    ],
  },
  {
    ref: 'weld',
    name: 'Welding Inspection Basics',
    code: 'WELD-13',
    description: 'Retired after the 2025 syllabus review. Kept archived for the material rather than the course.',
    subject: 'welding inspection',
    cover: { from: [100, 116, 139], to: [148, 163, 184], band: { top: 0.44, height: 0.1, color: [226, 232, 240] } },
    managerRef: 'khaled',
    priority: 'LOW',
    archived: true,
    startOffset: -300,
    ...
    modules: [
      { name: 'Module 01 — Welding Basics', lessons: ['Welding Processes', 'Weld Symbols', 'Welding Defects'] },
      { name: 'Module 02 — Inspection', lessons: ['Visual Inspection', 'Non-Destructive Testing', 'Inspection Reports'] },
    ],
  },
  {
    ref: 'ctrl',
    ...
    modules: [
      ...
      { name: 'Module 03 — Reporting', lessons: ['Dashboards and Reports', 'Change Management', 'Lessons Learned', 'Close-out Documentation'] },
    ],
  },
];
