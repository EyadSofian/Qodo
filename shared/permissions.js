...
export const ROLES = {
  ...
  manager: {
    ...
    nameAr: 'مدير',
    nameEn: 'Manager',
    descAr: 'يشوف كل المهام ويعدّل فيها، ويشوف المستخدمين — من غير تعديل على النظام.',
    permissions: [
  ...
  member: {
    ...
    nameAr: 'موظف',
    nameEn: 'Member',
    descAr: 'يشوف التطبيقات المسموح له بيها، ويشتغل على مهامه هو.',
    permissions: [PERMISSIONS.APPS_VIEW, PERMISSIONS.TASKS_VIEW, PERMISSIONS.TASKS_CREATE],
  },
  viewer: {
    id: 'viewer',
    nameAr: 'مشاهدة فقط',
    nameEn: 'Viewer',
    descAr: 'يفتح التطبيقات المسموح بيها ويقرأ المهام من غير أي تعديل.',
    permissions: [PERMISSIONS.APPS_VIEW, PERMISSIONS.TASKS_VIEW],
  },
};
